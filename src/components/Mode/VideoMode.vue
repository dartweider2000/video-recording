...
<template>
  <div class="grid gap-[5px]">
    ...
    <div
      v-show="isRecordingStarted"
      class="grid gap-[5px] grid-rows-[1fr,auto,auto]"
    >
      <TheTimer v-model="videoDuration" class="self-center" :tick="isLive" />
      <ElButton
      ...
      <ElButton v-if="isRecordingStarted" type="danger" @click="stopRecording">
        <ElIcon class="el-icon--left" :size="20">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
